...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"VisionTurnSpeedControl", {PERSISTENT | BACKUP, BOOL}},

    // Blend acc to e2e transition
    {"BlendAccToE2ETransition", {PERSISTENT | BACKUP, BOOL}},
    ...
    {"ToyotaAutoHold", {PERSISTENT | BACKUP, BOOL}},
    {"ToyotaEnhancedBsm", {PERSISTENT | BACKUP, BOOL}},
    {"ToyotaTSS2Long", {PERSISTENT | BACKUP, BOOL}},
    {"RainbowMode", {PERSISTENT | BACKUP, BOOL}},
    {"VibePersonalityEnabled", {PERSISTENT | BACKUP, BOOL}},
    {"VibeAccelPersonalityEnabled", {PERSISTENT | BACKUP, STRING}},
    {"VibeFollowPersonalityEnabled", {PERSISTENT | BACKUP, STRING}},
    {"AccelPersonality", {PERSISTENT | BACKUP, STRING}},
    {"ToyotaDriveMode", {PERSISTENT | BACKUP, BOOL}},
    // Speed Limit Control
    {"SpeedLimitControl", {PERSISTENT | BACKUP, BOOL}},
    {"SpeedLimitControlPolicy", {PERSISTENT | BACKUP, STRING}},
    {"SpeedLimitEngageType", {PERSISTENT | BACKUP, STRING}},
    {"SpeedLimitOffsetType", {PERSISTENT | BACKUP, STRING}},
    {"SpeedLimitValueOffset", {PERSISTENT | BACKUP, STRING}},
    {"SpeedLimitWarningType", {PERSISTENT | BACKUP, STRING}},
    {"SpeedLimitWarningOffsetType", {PERSISTENT | BACKUP, STRING}},
    {"SpeedLimitWarningValueOffset", {PERSISTENT | BACKUP, STRING}},
    {"RoadEdgeLaneChangeEnabled", {PERSISTENT | BACKUP, BOOL}},
