...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"OnroadLiteMode", {PERSISTENT | BACKUP, BOOL, "0"}},  // lightweight synthesized driving scene; no camera stream
    ...
    {"AutoNaviSpeedCtrlMode", {PERSISTENT | BACKUP, INT, "0"}},
    {"AutoNaviSpeedDecelRate", {PERSISTENT | BACKUP, INT, "150"}},
    {"AutoNaviSpeedSafetyFactor", {PERSISTENT | BACKUP, INT, "100"}},
