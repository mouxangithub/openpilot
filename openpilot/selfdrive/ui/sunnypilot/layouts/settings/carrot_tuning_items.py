...
def build_start_items():
  return [
    ...
    option_item_sp(title=tr('Soft Hold on Cancel'), param='SoftHoldOnCancel', min_value=0, max_value=2, value_change_step=1,
                   description=tr('Keep brakes applied after canceling cruise.')),
    option_item_sp(title=tr('Cruise Button Long Press Delay'), param='CruiseButtonLongDelay', min_value=0, max_value=200, value_change_step=5,
                   description=tr('Milliseconds before a long press is registered.')),

    section_heading_sp(tr('Speed Presets')),
...
def build_cruise_items():
  return [
    ...
    option_item_sp(title=tr('Lead Accel Response (Gap 1)'), param='LeadAccelResponseTF1', min_value=-1, max_value=5, value_change_step=1),
    option_item_sp(title=tr('Lead Accel Response (Gap 2)'), param='LeadAccelResponseTF2', min_value=-1, max_value=5, value_change_step=1),
    option_item_sp(title=tr('Lead Accel Response (Gap 3)'), param='LeadAccelResponseTF3', min_value=-1, max_value=5, value_change_step=1),
    option_item_sp(title=tr('Lead Accel Response (Gap 4)'), param='LeadAccelResponseTF4', min_value=-1, max_value=5, value_change_step=1),
    option_item_sp(title=tr('Speed Time-Gap Factor'), param='SpeedTFFactor', min_value=10, max_value=30, value_change_step=1),
    option_item_sp(title=tr('Follow-Gap Levels'), param='CruiseGapLevels', min_value=2, max_value=4, value_change_step=1),
    ...
    section_heading_sp(tr('Cruise Behavior')),
    ...
    option_item_sp(title=tr('Stop Speed Threshold'), param='VEgoStopping', min_value=0, max_value=500, value_change_step=5,
                   description=tr('Speed below which the car is considered stopped.')),
...
def build_navi_items():
  return [
    ...
    option_item_sp(title=tr('Navi Rear-Camera Hold Distance'), param='AutoNaviRearCameraHoldDistance', min_value=0, max_value=300, value_change_step=10),
...
def build_tuning_items():
  return [
    section_heading_sp(tr('Lateral Mode')),
    toggle_item_sp(title=tr('Always Lateral'), param='AlwaysLateral'),
    section_heading_sp(tr('Steering Limits')),
    ...
    section_heading_sp(tr('Path Offset')),
    ...
    section_heading_sp(tr('Lateral MPC Costs')),
    ...
    section_heading_sp(tr('Lateral Torque')),
    ...
    section_heading_sp(tr('Lateral Smoothing')),
    ...
    option_item_sp(title=tr('Lane Change BSD'), param='LaneChangeBsd', min_value=-1, max_value=1, value_change_step=1, description=tr('Use blind spot detection before lane changes.')),
    ...
    section_heading_sp(tr('Auto Turn / New Lane')),
    ...
    section_heading_sp(tr('Lane Line / ONNX')),
    option_item_sp(title=tr('Lane Line Check'), param='LaneLineCheck', min_value=0, max_value=2, value_change_step=1),
...
def build_display_items():
  return [
    ...
    section_heading_sp(tr('On-Screen Info')),
    ...
    option_item_sp(title=tr('Show Plot Mode'), param='ShowPlotMode', min_value=0, max_value=8, value_change_step=1),
    ...
    section_heading_sp(tr('Sound / Map')),
    ...
    section_heading_sp(tr('YouTube Live')),
...
def build_path_items():
  return [
    section_heading_sp(tr('Path Appearance')),
    option_item_sp(title=tr('Path Color'), param='ShowPathColor', min_value=0, max_value=10, value_change_step=1),
    option_item_sp(title=tr('Path Color Cruise Off'), param='ShowPathColorCruiseOff', min_value=0, max_value=19, value_change_step=1),
    ...
    section_heading_sp(tr('Trajectory / Lane Line')),
    toggle_item_sp(title=tr('Tire Trajectory'), param='CarrotTireTrajectory'),
    option_item_sp(title=tr('Use Lane Line Curve Speed'), param='UseLaneLineCurveSpeed', min_value=0, max_value=200, value_change_step=10),
    option_item_sp(title=tr('Use Lane Line Speed'), param='UseLaneLineSpeed', min_value=0, max_value=200, value_change_step=1),
  ]

def build_vehicle_items():
  return [
    section_heading_sp(tr('Driver / Safety')),
    option_item_sp(title=tr('Disable Min Steer Speed'), param='DisableMinSteerSpeed', min_value=0, max_value=1, value_change_step=1),
    section_heading_sp(tr('Vehicle Features')),
...
def build_dev_items():
  return [
    section_heading_sp(tr('CAN-FD Debug')),
    toggle_item_sp(title=tr('CANFD Debug'), param='CanfdDebug'),
    toggle_item_sp(title=tr('CANFD HDA2'), param='CanfdHDA2'),
    toggle_item_sp(title=tr('CANFD Stop & Retry'), param='CanfdStopRetry'),
    section_heading_sp(tr('Hardware / Tests')),
    toggle_item_sp(title=tr('C3x Lite Hardware'), param='HardwareC3xLite'),
    option_item_sp(title=tr('Cruise Button Test 1'), param='CruiseButtonTest1', min_value=1, max_value=20, value_change_step=1),
    option_item_sp(title=tr('Cruise Button Test 2'), param='CruiseButtonTest2', min_value=1, max_value=200, value_change_step=1),
    option_item_sp(title=tr('Cruise Button Test 3'), param='CruiseButtonTest3', min_value=1, max_value=20, value_change_step=1),
