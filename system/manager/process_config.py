...
def alwaysOnDM(started: bool, params: Params, CP: car.CarParams) -> bool:
  return params.get_bool("AlwaysOnDM") or driverview(started, params, CP)
...
procs = [
  ...
  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", alwaysOnDM, enabled=(WEBCAM or not PC)),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", alwaysOnDM, enabled=(WEBCAM or not PC)),
